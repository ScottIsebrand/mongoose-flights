...
// Route: INDEX (ie HTTP verb is GET; action is index; Mongoose func. is .find)
...
// Route: POST flight/document (ie HTTP verb is POST; action is create; Mongoose func. is .create)
